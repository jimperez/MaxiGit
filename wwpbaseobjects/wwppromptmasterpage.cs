...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwppromptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public wwppromptmasterpage( )
      {
      ...
      public wwppromptmasterpage( IGxContext context )
      {
      ...
      {
         return "WWPBaseObjects.WWPPromptMasterPage" ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUtcontentholder_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      {
         divUtcontentholder_Internalname = "UTCONTENTHOLDER_MPAGE";
      ...
      private String divUtcontentholder_Internalname ;
      private String sEvt ;
