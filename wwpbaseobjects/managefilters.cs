/*
       ...
       Generated on: 10/30/2019 19:1:57.31
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class managefilters : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201910301915737", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_12_0D2( true) ;
         }
         else
         {
            wb_table1_12_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_31_0D2( true) ;
         }
         else
         {
            wb_table2_31_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table2_31_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table2_31_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_31_0D2e( true) ;
         }
         else
         {
            wb_table2_31_0D2e( false) ;
         }
      }

      protected void wb_table1_12_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_12_0D2e( true) ;
         }
         else
         {
            wb_table1_12_0D2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20191030191581", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?20191030191581", false, true);
         context.AddJavascriptSource("Shared/jquery/jquery1.9.1.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD","{handler:'E130D2',iparms:[{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E110D2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("VMOVEUP.CLICK","{handler:'E140D2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("VMOVEDOWN.CLICK","{handler:'E150D2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("VUDELETE.CLICK","{handler:'E160D2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
