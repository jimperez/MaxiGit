/*
        ...
        Description: Gestionador de filtros
             Author: GeneXus C# Generator version 16_0_5-135614
       Generated on: 10/2/2019 19:12:58.28
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class managefilters : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201910219125833", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_12_0C2( true) ;
         }
         else
         {
            wb_table1_12_0C2( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_0C2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_31_0C2( true) ;
         }
         else
         {
            wb_table2_31_0C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_31_0C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 29), "GRIDGRIDSTATECOLLECTIONS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "VUDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "VUDELETE.CLICK") == 0 ) )
                           {
                              ...
                              if ( ( AV7GridStateCollection.Count >= AV29GXV1 ) && ( AV29GXV1 > 0 ) )
                              {
                                 ...
                                 context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavMoveup_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV16MoveUp)) ? AV32Moveup_GXI : context.convertURL( context.PathToRelativeUrl( AV16MoveUp))), !bGXsfl_15_Refreshing);
                                 ...
                                 context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavMovedown_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15MoveDown)) ? AV33Movedown_GXI : context.convertURL( context.PathToRelativeUrl( AV15MoveDown))), !bGXsfl_15_Refreshing);
                                 ...
                                 context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUdelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV6UDelete)) ? AV34Udelete_GXI : context.convertURL( context.PathToRelativeUrl( AV6UDelete))), !bGXsfl_15_Refreshing);
      ...
      protected void gxnrGridgridstatecollections_newrow( )
      {
         ...
         {
            sendrow_152( ) ;
            nGXsfl_15_idx = ((subGridgridstatecollections_Islastpage==1)&&(nGXsfl_15_idx+1>subGridgridstatecollections_Recordsperpage( )) ? 1 : nGXsfl_15_idx+1);
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_15_idx), 4, 0)), 4, "0");
            SubsflControlProps_152( ) ;
         }
      ...
      protected void initialize_formulas( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavGridstatecollection__gridstatexml_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavGridstatecollection__gridstatexml_Enabled), 5, 0)), !bGXsfl_15_Refreshing);
      }
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               nGXsfl_15_fel_idx = ((subGridgridstatecollections_Islastpage==1)&&(nGXsfl_15_fel_idx+1>subGridgridstatecollections_Recordsperpage( )) ? 1 : nGXsfl_15_fel_idx+1);
               sGXsfl_15_fel_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_15_fel_idx), 4, 0)), 4, "0");
      ...
      protected void wb_table2_31_0C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_31_0C2e( true) ;
         }
         else
         {
            wb_table2_31_0C2e( false) ;
         }
      }

      protected void wb_table1_12_0C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            if ( GridgridstatecollectionsContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Filtros") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeRealWidth"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_12_0C2e( true) ;
         }
         else
         {
            wb_table1_12_0C2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201910219125889", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?201910219125889", false, true);
         context.AddJavascriptSource("Shared/jquery/jquery1.9.1.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void sendrow_152( )
      {
         SubsflControlProps_152( ) ;
         WB0C0( ) ;
         if ( ( subGridgridstatecollections_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGridgridstatecollections_Recordsperpage( ) * 1 ) )
         {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD","{handler:'E130C2',iparms:[{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E110C2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("VMOVEUP.CLICK","{handler:'E140C2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("VMOVEDOWN.CLICK","{handler:'E150C2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
         ...
         setEventMetadata("VUDELETE.CLICK","{handler:'E160C2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:15,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]");
