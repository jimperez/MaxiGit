/*!   GeneXus C# 16_0_5-135614 on 10/30/2019 19:1:58.8
*/
...
gx.define('wwpbaseobjects.exportoptions', false, function () {
   ...
   DVPANEL_TABLEEXPORTContainer.setProp("Cls", "Cls", "PanelCard_GrayTitle", "str");
   ...
   GXValidFnc[60]={ id: 60, fld:"BTNDOWNLOADTOFILE",grid:0,evt:"e120b2_client"};
   GXValidFnc[61]={ id: 61, fld:"",grid:0};
   GXValidFnc[62]={ id: 62, fld:"BTNSAVEGOOGLEDRIVE",grid:0,evt:"e130b2_client"};
   GXValidFnc[63]={ id: 63, fld:"",grid:0};
   GXValidFnc[64]={ id: 64, fld:"BTNCANCEL",grid:0,evt:"e170b1_client"};
   ...
   this.Events = {"e120b2_client": ["'DODOWNLOADTOFILE'", true] ,"e130b2_client": ["'DOSAVEGOOGLEDRIVE'", true] ,"e160b2_client": ["ENTER", true] ,"e170b1_client": ["CANCEL", true] ,"e150b1_client": ["VEXPORTTYPE.CLICK", false]};
