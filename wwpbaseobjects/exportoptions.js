...
gx.define('wwpbaseobjects.exportoptions', false, function () {
   ...
   DVPANEL_TABLEEXPORTContainer.setProp("Cls", "Cls", "PanelFilled_BaseColor", "str");
   ...
   DVPANEL_TABLEATTRIBUTESContainer.setProp("Cls", "Cls", "PanelFilled_BaseColor", "str");
   ...
   GXValidFnc[60]={ id: 60, fld:"BTNDOWNLOADTOFILE",grid:0,evt:"e120a2_client"};
   GXValidFnc[61]={ id: 61, fld:"",grid:0};
   GXValidFnc[62]={ id: 62, fld:"BTNSAVEGOOGLEDRIVE",grid:0,evt:"e130a2_client"};
   GXValidFnc[63]={ id: 63, fld:"",grid:0};
   GXValidFnc[64]={ id: 64, fld:"BTNCANCEL",grid:0,evt:"e170a1_client"};
