/*
       ...
       Generated on: 10/30/2019 19:1:53.78
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomesampledata : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         initialize();
         Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "MaxiPrueba") ;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("targetNamespace", "MaxiPrueba");
               GXSoapXMLWriter.WriteAttribute("xmlns:wsdlns", "MaxiPrueba");
               ...
               GXSoapXMLWriter.WriteAttribute("xmlns:tns", "MaxiPrueba");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "MaxiPruebaaction/"+"wwpbaseobjects.AGETHOMESAMPLEDATA.Execute");
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteAttribute("xmlns", "MaxiPrueba");
            if ( currSoapErr == 0 )
            {
               if ( Gxm2rootcol != null )
               {
                  Gxm2rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "MaxiPrueba", "HomeSampleDataItem", "MaxiPrueba");
               }
            }
            else
            {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "MaxiPrueba") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem> aP0_Gxm2rootcol )
      {
         ...
         objgethomesampledata.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "MaxiPrueba") ;
      ...
      void executePrivate( )
      {
         ...
         Gxm1homesampledata = new GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem(context);
         Gxm2rootcol.Add(Gxm1homesampledata, 0);
         Gxm1homesampledata.gxTpr_Productname = "Tannat Wine";
         ...
         Gxm1homesampledata = new GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem(context);
         Gxm2rootcol.Add(Gxm1homesampledata, 0);
         Gxm1homesampledata.gxTpr_Productname = "Green Apple";
         ...
         Gxm1homesampledata = new GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem(context);
         Gxm2rootcol.Add(Gxm1homesampledata, 0);
         Gxm1homesampledata.gxTpr_Productname = "Delicious Cherries";
