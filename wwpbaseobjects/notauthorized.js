/*!   GeneXus C# 16_0_5-135614 on 10/30/2019 19:1:58.81
*/
...
gx.define('wwpbaseobjects.notauthorized', false, function () {
   ...
   GXValidFnc[20]={ id: 20, fld:"LOGINAGAIN", format:0,grid:0,evt:"e120h2_client"};
   GXValidFnc[23]={ id: 23, fld:"TORETURN", format:0,grid:0};
   GXValidFnc[25]={ id: 25, fld:"RETURN", format:0,grid:0};
   this.GxObject = "" ;
   this.Events = {"e120h2_client": ["LOGINAGAIN.CLICK", true] ,"e140h2_client": ["ENTER", true] ,"e150h2_client": ["CANCEL", true]};
