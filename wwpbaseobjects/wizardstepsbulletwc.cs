...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsbulletwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               {
                  AV25StepRealNumber = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  AV12StepNumber = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  AV10SelectedStepNumber = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  AV27FirstIsDummy = StringUtil.StrToBool( GetNextPar( ));
                  ajax_req_read_hidden_sdt(GetNextPar( ), AV26WizardStepsAux);
                  AV28LastIsDummy = StringUtil.StrToBool( GetNextPar( ));
                  ajax_req_read_hidden_sdt(GetNextPar( ), AV15WizardSteps);
                  AV29PenultimateIsDummy = StringUtil.StrToBool( GetNextPar( ));
                  sPrefix = GetNextPar( );
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"Wizardstepsaux", AV26WizardStepsAux);
         }
         else
         {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              {
                                 AV26WizardStepsAux.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV26WizardStepsAux.Item(AV35GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void gxgrGridwizardsteps_refresh( short AV25StepRealNumber ,
                                                  short AV12StepNumber ,
                                                  short AV10SelectedStepNumber ,
                                                  bool AV27FirstIsDummy ,
                                                  GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV26WizardStepsAux ,
                                                  bool AV28LastIsDummy ,
                                                  GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV15WizardSteps ,
                                                  bool AV29PenultimateIsDummy ,
                                                  String sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void E11082( )
      {
         ...
         {
            AV5WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV15WizardSteps.Item(AV37GXV3));
         ...
         if ( AV26WizardStepsAux.Count > AV23MaxStepsToShow )
         {
            ...
            {
               AV24StartIndex = (short)(AV10SelectedStepNumber+3-AV23MaxStepsToShow/ (decimal)(2));
               if ( AV24StartIndex + ( AV23MaxStepsToShow - 2 ) > AV26WizardStepsAux.Count + 1 )
               {
                  AV24StartIndex = (short)(AV26WizardStepsAux.Count-(AV23MaxStepsToShow-2)+1);
               }
            }
            if ( AV24StartIndex > 3 )
            {
               ...
               {
                  AV26WizardStepsAux.RemoveItem(3);
                  gx_BV5 = true;
            ...
            if ( AV26WizardStepsAux.Count > AV23MaxStepsToShow )
            {
               ...
               {
                  AV26WizardStepsAux.RemoveItem(AV26WizardStepsAux.Count-2);
                  gx_BV5 = true;
               }
            }
         }
      ...
      private void E12082( )
      {
         ...
         AV35GXV1 = 1;
         while ( AV35GXV1 <= AV26WizardStepsAux.Count )
         {
            AV26WizardStepsAux.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV26WizardStepsAux.Item(AV35GXV1));
            ...
            else if ( ( AV12StepNumber == AV26WizardStepsAux.Count ) && AV28LastIsDummy )
            {
               lblStepnumber_Caption = StringUtil.Trim( StringUtil.Str( (decimal)(AV15WizardSteps.Count), 9, 0));
            }
            else if ( ( AV12StepNumber == AV26WizardStepsAux.Count - 1 ) && AV29PenultimateIsDummy )
            {
               lblStepnumber_Caption = "...";
            }
            else if ( ( AV12StepNumber == 2 ) && AV27FirstIsDummy )
            {
            }
            else
            {
      ...
      {
         AV15WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "SIGMA");
         wcpOAV6CurrentStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV26WizardStepsAux = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "SIGMA");
         GXKey = "";
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
      ...
      private short AV25StepRealNumber ;
      ...
      private short AV23MaxStepsToShow ;
      private short AV24StartIndex ;
      ...
      private bool AV27FirstIsDummy ;
      private bool AV28LastIsDummy ;
      private bool AV29PenultimateIsDummy ;
      ...
      private bool gx_BV5 ;
      private bool AV30SecondIsDummy ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem> AV26WizardStepsAux ;
