/*
       ...
       Generated on: 10/30/2019 19:1:52.66
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class homeprogressbarcirclewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV6Percentage", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6Percentage), 4, 0)));
                  setjustcreated();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201910301915269", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm0I2( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?201910301915273", false, true);
         }
      ...
      protected void E110I2( )
      {
         ...
         ucUcpb.SendProperty(context, sPrefix, false, Ucpb_Internalname, "Percentage", StringUtil.LTrim( StringUtil.Str( (decimal)(Ucpb_Percentage), 9, 0)));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201910301915292", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?201910301915292", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
         }
