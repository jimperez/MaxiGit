/*!   GeneXus C# 16_0_5-135614 on 10/3/2019 15:38:2.51
*/
...
gx.define('wwpbaseobjects.wizardstepsbulletwc', true, function (CmpContext) {
   ...
   this.GridwizardstepsContainer = new gx.grid.grid(this, 2,"WbpLvl2",5,"Gridwizardsteps","Gridwizardsteps","GridwizardstepsContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.wizardstepsbulletwc",[],true,0,true,true,0,false,false,false,"CollWWPBaseObjects\WizardSteps.WizardStepsItem",0,"px",0,"px","Nueva fila",false,false,false,null,null,false,"AV26WizardStepsAux",false,[1,1,1,1],false,0,false,false);
   ...
   this.EvtParms["REFRESH"] = [[{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'GRIDWIZARDSTEPS_nEOF'},{av:'AV26WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:''},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC'},{av:'AV15WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'sPrefix'},{av:'AV25StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV10SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV27FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV28LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV29PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true}],[]];
   this.EvtParms["START"] = [[{av:'AV15WizardSteps',fld:'vWIZARDSTEPS',pic:''},{av:'AV6CurrentStep',fld:'vCURRENTSTEP',pic:''},{av:'AV26WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:''},{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC'},{av:'GRIDWIZARDSTEPS_nEOF'},{av:'AV25StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV10SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV27FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV28LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV29PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true},{av:'sPrefix'}],[{av:'AV10SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV25StepRealNumber',fld:'vSTEPREALNUMBER',pic:'ZZZ9',hsh:true},{av:'AV26WizardStepsAux',fld:'vWIZARDSTEPSAUX',grid:5,pic:''},{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC'},{av:'AV27FirstIsDummy',fld:'vFIRSTISDUMMY',pic:'',hsh:true},{av:'AV29PenultimateIsDummy',fld:'vPENULTIMATEISDUMMY',pic:'',hsh:true},{av:'AV28LastIsDummy',fld:'vLASTISDUMMY',pic:'',hsh:true},{av:'AV12StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true}]];
