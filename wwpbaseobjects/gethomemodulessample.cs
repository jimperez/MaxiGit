/*
               File: WWPBaseObjects.GetHomeModulesSample
        Description: Get Home Modules Sample
             Author: GeneXus C# Generator version 16_0_5-135614
       Generated on: 10/2/2019 14:15:39.83
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomemodulessample : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "SIGMA") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem> aP0_Gxm2rootcol )
      {
         ...
         objgethomemodulessample.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "SIGMA") ;
