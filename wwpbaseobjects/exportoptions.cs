   ...
   public class exportoptions : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void wb_table1_6_0A2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_15_0A2( true) ;
         }
         else
         {
            wb_table2_15_0A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_15_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_52_0A2( true) ;
         }
         else
         {
            wb_table3_52_0A2( false) ;
         }
         return  ;
      }

      protected void wb_table3_52_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table3_52_0A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_52_0A2e( true) ;
         }
         else
         {
            wb_table3_52_0A2e( false) ;
         }
      }

      protected void wb_table2_15_0A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_element( context, cmbavExporttype_Internalname, "Tipo de exportación", "col-sm-3 AttributeRealWidthLabel", 1, true);
            /* Div Control */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='ExportOptionsPanellCell'>") ;
            wb_table4_28_0A2( true) ;
         }
         else
         {
            wb_table4_28_0A2( false) ;
         }
         return  ;
      }

      protected void wb_table4_28_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_15_0A2e( true) ;
         }
         else
         {
            wb_table2_15_0A2e( false) ;
         }
      }

      protected void wb_table4_28_0A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUser_Internalname, "Email", "col-sm-3 AttributeRealWidthLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavDoctitle_Internalname, "Título del documento", "col-sm-3 AttributeRealWidthLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavPassword_Internalname, "Contraseña", "col-sm-3 AttributeRealWidthLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_28_0A2e( true) ;
         }
         else
         {
            wb_table4_28_0A2e( false) ;
         }
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableattributes_Cls = "PanelFilled_BaseColor";
         ...
         Dvpanel_tableexport_Cls = "PanelFilled_BaseColor";
