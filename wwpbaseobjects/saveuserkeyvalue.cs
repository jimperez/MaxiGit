/*
       ...
       Generated on: 11/1/2019 15:36:51.57
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class saveuserkeyvalue : GXProcedure
   {
      ...
      {
         this.AV15UserCustomizationsKey = aP0_UserCustomizationsKey;
         this.AV16UserCustomizationsValue = aP1_UserCustomizationsValue;
         initialize();
         executePrivate();
      }
                                 ...
                                 String aP1_UserCustomizationsValue )
      {
         ...
         objsaveuserkeyvalue.AV15UserCustomizationsKey = aP0_UserCustomizationsKey;
         objsaveuserkeyvalue.AV16UserCustomizationsValue = aP1_UserCustomizationsValue;
      ...
      void executePrivate( )
      {
         ...
         AV8Session.Set(AV15UserCustomizationsKey, AV16UserCustomizationsValue);
         this.cleanup();
      }
      ...
      private String AV16UserCustomizationsValue ;
      private String AV15UserCustomizationsKey ;
