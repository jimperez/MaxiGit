/*!   GeneXus C# 16_0_5-135614 on 10/30/2019 19:1:58.34
*/
...
gx.define('wwpbaseobjects.managefilters', false, function () {
   ...
   GridgridstatecollectionsContainer.addBitmap("&Moveup","vMOVEUP",16,0,"px",17,"px","e140d2_client","","","ActionBaseColorAttribute","WWActionColumn");
   GridgridstatecollectionsContainer.addBitmap("&Movedown","vMOVEDOWN",17,0,"px",17,"px","e150d2_client","","","ActionBaseColorAttribute","WWActionColumn");
   GridgridstatecollectionsContainer.addSingleLineEdit("GXV2",18,"GRIDSTATECOLLECTION__TITLE","Filtros","","Title","svchar",0,"px",100,80,"left",null,[],"GXV2","GXV2",true,0,false,false,"Attribute",1,"WWColumn");
   ...
   GridgridstatecollectionsContainer.addBitmap("&Udelete","vUDELETE",20,0,"px",17,"px","e160d2_client","","","DeleteAttribute","WWActionColumn");
   ...
   GXValidFnc[25]={ id: 25, fld:"BTNENTER",grid:0,evt:"e110d2_client",std:"ENTER"};
   GXValidFnc[26]={ id: 26, fld:"",grid:0};
   GXValidFnc[27]={ id: 27, fld:"BTNCANCEL",grid:0,evt:"e170d1_client"};
   ...
   this.Events = {"e110d2_client": ["ENTER", true] ,"e140d2_client": ["VMOVEUP.CLICK", true] ,"e150d2_client": ["VMOVEDOWN.CLICK", true] ,"e160d2_client": ["VUDELETE.CLICK", true] ,"e170d1_client": ["CANCEL", true]};
