...
gx.define('wwpbaseobjects.home', false, function () {
   ...
   {
      this.AV10HomeModulesSDT=gx.fn.getControlValue("vHOMEMODULESSDT") ;
   };
   ...
   GXValidFnc[17]={ id:17 ,lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:12,gxgrid:this.BannerContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vIMAGEBANNER",gxz:"ZV11ImageBanner",gxold:"OV11ImageBanner",gxvar:"AV11ImageBanner",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){if(Value!==undefined)gx.O.AV11ImageBanner=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV11ImageBanner=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vIMAGEBANNER",row || gx.fn.currentGridRowImpl(12),gx.O.AV11ImageBanner,gx.O.AV19Imagebanner_GXI)},c2v:function(row){gx.O.AV19Imagebanner_GXI=this.val_GXI();if(this.val(row)!==undefined)gx.O.AV11ImageBanner=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vIMAGEBANNER",row || gx.fn.currentGridRowImpl(12))},val_GXI:function(row){return gx.fn.getGridControlValue("vIMAGEBANNER_GXI",row || gx.fn.currentGridRowImpl(12))}, gxvar_GXI:'AV19Imagebanner_GXI',nac:gx.falseFn};
   ...
   GXValidFnc[28]={ id:28 ,lvl:3,type:"svchar",len:100,dec:0,sign:false,ro:1,isacc:0,grid:20,gxgrid:this.GridhomemodulessdtsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"HOMEMODULESSDT__OPTIONTITLE",gxz:"ZV17GXV2",gxold:"OV17GXV2",gxvar:"GXV2",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){if(Value!==undefined)gx.O.GXV2=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV17GXV2=Value},v2c:function(row){gx.fn.setGridControlValue("HOMEMODULESSDT__OPTIONTITLE",row || gx.fn.currentGridRowImpl(20),gx.O.GXV2,0)},c2v:function(row){if(this.val(row)!==undefined)gx.O.GXV2=this.val(row)},val:function(row){return gx.fn.getGridControlValue("HOMEMODULESSDT__OPTIONTITLE",row || gx.fn.currentGridRowImpl(20))},nac:gx.falseFn};
   GXValidFnc[29]={ id: 29, fld:"",grid:20};
   GXValidFnc[30]={ id: 30, fld:"",grid:20};
   GXValidFnc[31]={ id: 31, fld:"",grid:20};
   GXValidFnc[32]={ id:32 ,lvl:3,type:"svchar",len:100,dec:0,sign:false,ro:1,isacc:0,grid:20,gxgrid:this.GridhomemodulessdtsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"HOMEMODULESSDT__OPTIONDESCRIPTION",gxz:"ZV18GXV3",gxold:"OV18GXV3",gxvar:"GXV3",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){if(Value!==undefined)gx.O.GXV3=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV18GXV3=Value},v2c:function(row){gx.fn.setGridControlValue("HOMEMODULESSDT__OPTIONDESCRIPTION",row || gx.fn.currentGridRowImpl(20),gx.O.GXV3,0)},c2v:function(row){if(this.val(row)!==undefined)gx.O.GXV3=this.val(row)},val:function(row){return gx.fn.getGridControlValue("HOMEMODULESSDT__OPTIONDESCRIPTION",row || gx.fn.currentGridRowImpl(20))},nac:gx.falseFn};
   this.ZV11ImageBanner = "" ;
   this.OV11ImageBanner = "" ;
   this.ZV17GXV2 = "" ;
   this.OV17GXV2 = "" ;
   this.ZV18GXV3 = "" ;
   this.OV18GXV3 = "" ;
   this.AV11ImageBanner = "" ;
   this.GXV2 = "" ;
   this.GXV3 = "" ;
   ...
   this.addGridBCProperty("Homemodulessdt", ["OptionDescription"], this.GXValidFnc[32], "AV10HomeModulesSDT");
   this.Initialize( );
});
