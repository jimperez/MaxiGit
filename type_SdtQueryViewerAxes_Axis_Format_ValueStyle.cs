...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Format.ValueStyle" , Namespace="MaxiPrueba" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Format.ValueStyle", Namespace="MaxiPrueba")]
