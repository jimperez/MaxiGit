...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Filter" , Namespace="MaxiPrueba" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Filter", Namespace="MaxiPrueba")]
