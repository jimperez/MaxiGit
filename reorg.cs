/*
       ...
       Generated on: 10/30/2019 19:13:40.67
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTipoTelefono( )
      {
         String cmdBuffer = "" ;
         /* Indices for table TipoTelefono */
         cmdBuffer=" ALTER TABLE [TipoTelefono] ALTER COLUMN [TipTelNom]  nchar(20) NOT NULL  "
         ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            TipoTelefonoCount = P00012_ATipoTelefonoCount[0];
            pr_default.close(0);
            PrintRecordCount ( "TipoTelefono" ,  TipoTelefonoCount );
         }
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeTipoTelefono" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"TipoTelefono", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_ATipoTelefonoCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int TipoTelefonoCount ;
      ...
      protected int[] P00012_ATipoTelefonoCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [TipoTelefono] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
