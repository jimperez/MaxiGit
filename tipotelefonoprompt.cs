/*
               File: TipoTelefonoPrompt
        Description: Selecciona Tipo Telefono
             Author: GeneXus C# Generator version 16_0_5-135614
       Generated on: 10/30/2019 18:44:12.46
...
namespace GeneXus.Programs {
   public class tipotelefonoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public tipotelefonoprompt( )
      {
      ...
      public tipotelefonoprompt( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV21InOutTipTelNom = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21InOutTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV21InOutTipTelNom), 4, 0)));
               }
            }
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2019103018441265", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("tipotelefonoprompt.aspx") + "?" + UrlEncode("" +AV20InOutTipTelId) + "," + UrlEncode("" +AV21InOutTipTelNom)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTTIPTELNOM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV21InOutTipTelNom), 4, 0, ",", "")));
      ...
      {
         return formatLink("tipotelefonoprompt.aspx") + "?" + UrlEncode("" +AV20InOutTipTelId) + "," + UrlEncode("" +AV21InOutTipTelNom) ;
      }

      public override String GetPgmname( )
      {
         return "TipoTelefonoPrompt" ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_12_0P2( true) ;
         }
         else
         {
            wb_table1_12_0P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_0P2e( bool wbgen )
      {
         if ( wbgen )
         {
         ...
         if ( wbEnd == 24 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8OrderedBy), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoPrompt.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 40,'',false,'" + sGXsfl_24_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV9OrderedDsc), StringUtil.BoolToStr( AV9OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,40);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_TipoTelefonoPrompt.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TIPTELNOM", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A3TipTelNom), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "TIPTELNOM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3TipTelNom), 4, 0, ".", "")));
      }
      ...
      protected void RF0P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV9OrderedDsc } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                                 }
            } ) ;
            ...
            {
               A3TipTelNom = H000P2_A3TipTelNom[0];
               A1TipTelId = H000P2_A1TipTelId[0];
               E180P2 ();
      ...
      protected void send_integrity_lvl_hashes0P2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TIPTELNOM"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A3TipTelNom), "ZZZ9"), context));
      }
      ...
      protected void E190P2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21InOutTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV21InOutTipTelNom), 4, 0)));
         context.setWebReturnParms(new Object[] {(int)AV20InOutTipTelId,(short)AV21InOutTipTelNom});
      ...
      protected void wb_table1_12_0P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgCleanfilters_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Limpiar filtros", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_TipoTelefonoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV20InOutTipTelId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV20InOutTipTelId), 9, 0)));
         AV21InOutTipTelNom = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21InOutTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV21InOutTipTelNom), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2019103018441471", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipotelefonoprompt.js", "?2019103018441472", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_TIPTELID.ONOPTIONCLICKED","{handler:'E130P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV9OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV12ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV14ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'Ddo_tiptelid_Activeeventkey',ctrl:'DDO_TIPTELID',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_TIPTELNOM.ONOPTIONCLICKED","{handler:'E140P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV9OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV12ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV14ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'Ddo_tiptelnom_Activeeventkey',ctrl:'DDO_TIPTELNOM',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E180P2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''},{av:'edtavSelect_Tooltiptext',ctrl:'vSELECT',prop:'Tooltiptext'}]}");
         setEventMetadata("ENTER","{handler:'E190P2',iparms:[{av:'A1TipTelId',fld:'TIPTELID',pic:'ZZZZZZZZ9',hsh:true},{av:'A3TipTelNom',fld:'TIPTELNOM',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV20InOutTipTelId',fld:'vINOUTTIPTELID',pic:'ZZZZZZZZ9'},{av:'AV21InOutTipTelNom',fld:'vINOUTTIPTELNOM',pic:'ZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E150P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV9OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV12ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV14ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV10FilterFullText = "";
         H000P2_A3TipTelNom = new short[1] ;
         H000P2_A1TipTelId = new int[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipotelefonoprompt__default(),
            new Object[][] {
                new Object[] {
               H000P2_A3TipTelNom, H000P2_A1TipTelId
               }
               , new Object[] {
      ...
      private short AV21InOutTipTelNom ;
      private short wcpOAV21InOutTipTelNom ;
      ...
      private short aP1_InOutTipTelNom ;
      private IDataStoreProvider pr_default ;
      private short[] H000P2_A3TipTelNom ;
      private int[] H000P2_A1TipTelId ;
   ...
   public class tipotelefonoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV9OrderedDsc )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10FilterFullText)) )
         {
            ...
            {
               sWhereString = sWhereString + " and (( CONVERT( char(9), CAST([TipTelId] AS decimal(9,0))) like '%' + @lV10FilterFullText) or ( CONVERT( char(4), CAST([TipTelNom] AS decimal(4,0))) like '%' + @lV10FilterFullText))";
            }
            else
            {
               sWhereString = sWhereString + " (( CONVERT( char(9), CAST([TipTelId] AS decimal(9,0))) like '%' + @lV10FilterFullText) or ( CONVERT( char(4), CAST([TipTelNom] AS decimal(4,0))) like '%' + @lV10FilterFullText))";
            }
         }
         else
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000P2(context, (String)dynConstraints[0] , (int)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H000P3(context, (String)dynConstraints[0] , (int)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
         }
