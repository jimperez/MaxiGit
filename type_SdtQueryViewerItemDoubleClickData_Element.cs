...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Element" , Namespace="MaxiPrueba" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Element", Namespace="MaxiPrueba")]
