/*!   GeneXus C# 16_0_5-135614 on 11/1/2019 9:14:49.20
*/
...
gx.define('recentlinks', true, function (CmpContext) {
   ...
   this.LinksContainer = new gx.grid.grid(this, 2,"WbpLvl2",7,"Links","Links","LinksContainer",this.CmpContext,this.IsMasterPage,"recentlinks",[],true,0,true,true,0,false,false,false,"",0,"px",0,"px","Nueva fila",false,false,false,null,null,false,"",false,[1,1,1,1],false,0,false,false);
   ...
   GXValidFnc[5]={ id: 5, fld:"RECENTTEXT", format:0,grid:0};
   GXValidFnc[10]={ id: 10, fld:"PLACE", format:0,grid:7};
   GXValidFnc[12]={ id: 12, fld:"PIPE", format:0,grid:7};
