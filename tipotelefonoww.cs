/*
       ...
       Generated on: 10/30/2019 18:44:16.40
...
namespace GeneXus.Programs {
   public class tipotelefonoww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public tipotelefonoww( )
      {
      ...
      public tipotelefonoww( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV48TFTipTelNom = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV49TFTipTelNom_To = (short)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV15FilterFullText, AV12OrderedBy, AV13OrderedDsc, AV44TFTipTelId, AV45TFTipTelId_To, AV48TFTipTelNom, AV49TFTipTelNom_To, AV37ManageFiltersExecutionStep, AV30ColumnsSelector, AV46ddo_TipTelIdTitleControlIdToReplace, AV50ddo_TipTelNomTitleControlIdToReplace, AV63Pgmname) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2019103018441671", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tipotelefonoww.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vTFTIPTELNOM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV48TFTipTelNom), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vTFTIPTELNOM_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV49TFTipTelNom_To), 4, 0, ",", "")));
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "DDO_TIPTELNOM_Filteredtextto_set", StringUtil.RTrim( Ddo_tiptelnom_Filteredtextto_set));
         ...
         GxWebStd.gx_hidden_field( context, "DDO_TIPTELNOM_Rangefilterfrom", StringUtil.RTrim( Ddo_tiptelnom_Rangefilterfrom));
         GxWebStd.gx_hidden_field( context, "DDO_TIPTELNOM_Rangefilterto", StringUtil.RTrim( Ddo_tiptelnom_Rangefilterto));
         ...
         GxWebStd.gx_hidden_field( context, "DDO_TIPTELNOM_Filteredtextto_get", StringUtil.RTrim( Ddo_tiptelnom_Filteredtextto_get));
      ...
      {
         return formatLink("tipotelefonoww.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "TipoTelefonoWW" ;
      }
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TipoTelefonoWW.htm");
            ...
            ClassString = "ButtonColorFilled";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Excel", bttBtnexport_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TipoTelefonoWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "ButtonColorFilled";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexportreport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "PDF", bttBtnexportreport_Jsonclick, 5, "Exportar a PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORTREPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TipoTelefonoWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Selecciona columnas", bttBtneditcolumns_Jsonclick, 0, "Selecciona columnas", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_TipoTelefonoWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_25_0O2( true) ;
         }
         else
         {
            wb_table1_25_0O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_0O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtTipTelNom_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3TipTelNom), 4, 0, ".", "")));
         ...
         if ( wbEnd == 43 )
         {
            ...
            ucDdo_tiptelnom.SetProperty("RangeFilterFrom", Ddo_tiptelnom_Rangefilterfrom);
            ucDdo_tiptelnom.SetProperty("RangeFilterTo", Ddo_tiptelnom_Rangefilterto);
            ...
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12OrderedBy), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV12OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,60);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 61,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV13OrderedDsc), StringUtil.BoolToStr( AV13OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 62,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagefiltersexecutionstep_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV37ManageFiltersExecutionStep), 1, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV37ManageFiltersExecutionStep), "9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,62);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagefiltersexecutionstep_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagefiltersexecutionstep_Visible, 1, 0, "number", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTftiptelid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV44TFTipTelId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV44TFTipTelId), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTftiptelid_Jsonclick, 0, "Attribute", "", "", "", "", edtavTftiptelid_Visible, 1, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 64,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTftiptelid_to_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV45TFTipTelId_To), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV45TFTipTelId_To), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTftiptelid_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTftiptelid_to_Visible, 1, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 65,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTftiptelnom_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV48TFTipTelNom), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV48TFTipTelNom), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTftiptelnom_Jsonclick, 0, "Attribute", "", "", "", "", edtavTftiptelnom_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'" + sGXsfl_43_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTftiptelnom_to_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV49TFTipTelNom_To), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV49TFTipTelNom_To), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTftiptelnom_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTftiptelnom_to_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_TipoTelefonoWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A3TipTelNom = (short)(context.localUtil.CToN( cgiGet( edtTipTelNom_Internalname), ",", "."));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vTFTIPTELNOM"), ",", ".") != Convert.ToDecimal( AV48TFTipTelNom )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Tftiptelnom_to Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vTFTIPTELNOM_TO"), ",", ".") != Convert.ToDecimal( AV49TFTipTelNom_To )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV48TFTipTelNom ,
                                       short AV49TFTipTelNom_To ,
      ...
      protected void RF0O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV58TipoTelefonoWWDS_1_Filterfulltext ,
                                                 AV59TipoTelefonoWWDS_2_Tftiptelid ,
                                                 AV60TipoTelefonoWWDS_3_Tftiptelid_to ,
                                                 AV61TipoTelefonoWWDS_4_Tftiptelnom ,
                                                 AV62TipoTelefonoWWDS_5_Tftiptelnom_to ,
                                                 A1TipTelId ,
                                                 A3TipTelNom ,
                                                 AV12OrderedBy ,
                                                 AV13OrderedDsc } ,
            ...
            lV58TipoTelefonoWWDS_1_Filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV58TipoTelefonoWWDS_1_Filterfulltext), "%", "");
            lV58TipoTelefonoWWDS_1_Filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV58TipoTelefonoWWDS_1_Filterfulltext), "%", "");
            /* Using cursor H000O2 */
            pr_default.execute(0, new Object[] {lV58TipoTelefonoWWDS_1_Filterfulltext, lV58TipoTelefonoWWDS_1_Filterfulltext, AV59TipoTelefonoWWDS_2_Tftiptelid, AV60TipoTelefonoWWDS_3_Tftiptelid_to, AV61TipoTelefonoWWDS_4_Tftiptelnom, AV62TipoTelefonoWWDS_5_Tftiptelnom_to, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_43_idx = 1;
            sGXsfl_43_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_43_idx), 4, 0)), 4, "0");
            SubsflControlProps_432( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A3TipTelNom = H000O2_A3TipTelNom[0];
               A1TipTelId = H000O2_A1TipTelId[0];
               E220O2 ();
      ...
      {
         AV58TipoTelefonoWWDS_1_Filterfulltext = AV15FilterFullText;
         AV59TipoTelefonoWWDS_2_Tftiptelid = AV44TFTipTelId;
         AV60TipoTelefonoWWDS_3_Tftiptelid_to = AV45TFTipTelId_To;
         AV61TipoTelefonoWWDS_4_Tftiptelnom = AV48TFTipTelNom;
         AV62TipoTelefonoWWDS_5_Tftiptelnom_to = AV49TFTipTelNom_To;
         ...
         lV58TipoTelefonoWWDS_1_Filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV58TipoTelefonoWWDS_1_Filterfulltext), "%", "");
         /* Using cursor H000O3 */
         pr_default.execute(1, new Object[] {lV58TipoTelefonoWWDS_1_Filterfulltext, lV58TipoTelefonoWWDS_1_Filterfulltext, AV59TipoTelefonoWWDS_2_Tftiptelid, AV60TipoTelefonoWWDS_3_Tftiptelid_to, AV61TipoTelefonoWWDS_4_Tftiptelnom, AV62TipoTelefonoWWDS_5_Tftiptelnom_to});
      ...
      protected void STRUP0O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavTftiptelnom_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavTftiptelnom_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vTFTIPTELNOM");
               GX_FocusControl = edtavTftiptelnom_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV48TFTipTelNom = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV48TFTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV48TFTipTelNom), 4, 0)));
            }
            else
            {
               AV48TFTipTelNom = (short)(context.localUtil.CToN( cgiGet( edtavTftiptelnom_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV48TFTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV48TFTipTelNom), 4, 0)));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavTftiptelnom_to_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavTftiptelnom_to_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vTFTIPTELNOM_TO");
               GX_FocusControl = edtavTftiptelnom_to_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV49TFTipTelNom_To = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV49TFTipTelNom_To", StringUtil.LTrim( StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0)));
            }
            else
            {
               AV49TFTipTelNom_To = (short)(context.localUtil.CToN( cgiGet( edtavTftiptelnom_to_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV49TFTipTelNom_To", StringUtil.LTrim( StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0)));
            }
            /* Read saved values. */
            ...
            Ddo_tiptelnom_Filteredtextto_set = cgiGet( "DDO_TIPTELNOM_Filteredtextto_set");
            ...
            Ddo_tiptelnom_Rangefilterfrom = cgiGet( "DDO_TIPTELNOM_Rangefilterfrom");
            Ddo_tiptelnom_Rangefilterto = cgiGet( "DDO_TIPTELNOM_Rangefilterto");
            ...
            Ddo_tiptelnom_Filteredtextto_get = cgiGet( "DDO_TIPTELNOM_Filteredtextto_get");
      ...
      protected void E200O2( )
      {
         ...
         edtavTftiptelnom_to_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavTftiptelnom_to_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavTftiptelnom_to_Visible), 5, 0)), true);
      ...
      protected void E210O2( )
      {
         ...
         if ( StringUtil.StrCmp(AV36Session.Get("TipoTelefonoWWColumnsSelector"), "") != 0 )
         {
            AV18ColumnsSelectorXML = AV36Session.Get("TipoTelefonoWWColumnsSelector");
      ...
      protected void E150O2( )
      {
         ...
         {
            AV48TFTipTelNom = (short)(NumberUtil.Val( Ddo_tiptelnom_Filteredtext_get, "."));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV48TFTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV48TFTipTelNom), 4, 0)));
            AV49TFTipTelNom_To = (short)(NumberUtil.Val( Ddo_tiptelnom_Filteredtextto_get, "."));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV49TFTipTelNom_To", StringUtil.LTrim( StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0)));
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
      ...
      private void E220O2( )
      {
         ...
         edtTipTelNom_Link = formatLink("tipotelefonoview.aspx") + "?" + UrlEncode("" +A1TipTelId) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 43;
      ...
      protected void E160O2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "TipoTelefonoWWColumnsSelector",  AV30ColumnsSelector.ToXml(false, true, "WWPColumnsSelector", "MaxiPrueba")) ;
         context.DoAjaxRefresh();
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV30ColumnsSelector", AV30ColumnsSelector);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV43TipTelIdTitleFilterData", AV43TipTelIdTitleFilterData);
      ...
      protected void E110O2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx") + "?" + UrlEncode(StringUtil.RTrim("TipoTelefonoWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV63Pgmname+"GridState")), new Object[] {});
            AV37ManageFiltersExecutionStep = 2;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV37ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV37ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx") + "?" + UrlEncode(StringUtil.RTrim("TipoTelefonoWWFilters")), new Object[] {});
            AV37ManageFiltersExecutionStep = 2;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV37ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV37ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "TipoTelefonoWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV63Pgmname+"GridState",  AV38ManageFiltersXml) ;
      ...
      protected void E180O2( )
      {
         ...
         new tipotelefonowwexport(context ).execute( out  AV16ExcelFilename, out  AV17ErrorMessage) ;
      ...
      protected void E190O2( )
      {
         ...
         Innewwindow1_Target = formatLink("tipotelefonowwexportreport.aspx") ;
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "TipoTelefonoWWColumnsSelector", out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         AV41ManageFiltersData.Add(AV42ManageFiltersDataItem, 0);
         AV39ManageFiltersItems.FromXml(new GeneXus.Programs.wwpbaseobjects.loadmanagefiltersstate(context).executeUdp(  "TipoTelefonoWWFilters"), null, "Items", "");
         AV64GXV1 = 1;
         while ( AV64GXV1 <= AV39ManageFiltersItems.Count )
         {
            AV40ManageFiltersItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV39ManageFiltersItems.Item(AV64GXV1));
            AV42ManageFiltersDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
      ...
      protected void S182( )
      {
         ...
         AV49TFTipTelNom_To = 0;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV49TFTipTelNom_To", StringUtil.LTrim( StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0)));
         Ddo_tiptelnom_Filteredtextto_set = "";
         ucDdo_tiptelnom.SendProperty(context, "", false, Ddo_tiptelnom_Internalname, "FilteredTextTo_set", Ddo_tiptelnom_Filteredtextto_set);
      }
      ...
      protected void S132( )
      {
         ...
         if ( StringUtil.StrCmp(AV36Session.Get(AV63Pgmname+"GridState"), "") == 0 )
         {
            AV10GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV63Pgmname+"GridState"), null, "WWPGridState", "MaxiPrueba");
         }
         else
         {
            AV10GridState.FromXml(AV36Session.Get(AV63Pgmname+"GridState"), null, "WWPGridState", "MaxiPrueba");
         }
         AV12OrderedBy = AV10GridState.gxTpr_Orderedby;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12OrderedBy", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12OrderedBy), 4, 0)));
         AV13OrderedDsc = AV10GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         AV65GXV2 = 1;
         while ( AV65GXV2 <= AV10GridState.gxTpr_Filtervalues.Count )
         {
            AV11GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV10GridState.gxTpr_Filtervalues.Item(AV65GXV2));
            ...
            {
               AV48TFTipTelNom = (short)(NumberUtil.Val( AV11GridStateFilterValue.gxTpr_Value, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV48TFTipTelNom", StringUtil.LTrim( StringUtil.Str( (decimal)(AV48TFTipTelNom), 4, 0)));
               AV49TFTipTelNom_To = (short)(NumberUtil.Val( AV11GridStateFilterValue.gxTpr_Valueto, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV49TFTipTelNom_To", StringUtil.LTrim( StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0)));
               if ( ! (0==AV48TFTipTelNom) )
               {
                  Ddo_tiptelnom_Filteredtext_set = StringUtil.Str( (decimal)(AV48TFTipTelNom), 4, 0);
                  ucDdo_tiptelnom.SendProperty(context, "", false, Ddo_tiptelnom_Internalname, "FilteredText_set", Ddo_tiptelnom_Filteredtext_set);
               }
               if ( ! (0==AV49TFTipTelNom_To) )
               {
                  Ddo_tiptelnom_Filteredtextto_set = StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0);
                  ucDdo_tiptelnom.SendProperty(context, "", false, Ddo_tiptelnom_Internalname, "FilteredTextTo_set", Ddo_tiptelnom_Filteredtextto_set);
               }
            }
      ...
      protected void S152( )
      {
         ...
         if ( ! ( (0==AV48TFTipTelNom) && (0==AV49TFTipTelNom_To) ) )
         {
            AV11GridStateFilterValue = new GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue(context);
            AV11GridStateFilterValue.gxTpr_Name = "TFTIPTELNOM";
            AV11GridStateFilterValue.gxTpr_Value = StringUtil.Str( (decimal)(AV48TFTipTelNom), 4, 0);
            AV11GridStateFilterValue.gxTpr_Valueto = StringUtil.Str( (decimal)(AV49TFTipTelNom_To), 4, 0);
            AV10GridState.gxTpr_Filtervalues.Add(AV11GridStateFilterValue, 0);
         }
         AV10GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         AV10GridState.gxTpr_Currentpage = (short)(subGrid_Currentpage( ));
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV63Pgmname+"GridState",  AV10GridState.ToXml(false, true, "WWPGridState", "MaxiPrueba")) ;
      }
      ...
      protected void wb_table1_25_0O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_30_0O2( true) ;
         }
         else
         {
            wb_table2_30_0O2( false) ;
         }
         return  ;
      }

      protected void wb_table2_30_0O2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_25_0O2e( true) ;
         }
         else
         {
            wb_table1_25_0O2e( false) ;
         }
      }

      protected void wb_table2_30_0O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2019103018442112", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipotelefonoww.js", "?2019103018442113", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavTftiptelnom_to_Internalname = "vTFTIPTELNOM_TO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavTftiptelnom_to_Jsonclick = "";
         edtavTftiptelnom_to_Visible = 1;
         ...
         Ddo_tiptelnom_Rangefilterto = "WWP_TSTo";
         Ddo_tiptelnom_Rangefilterfrom = "WWP_TSFrom";
         ...
         Ddo_tiptelnom_Filterisrange = Convert.ToBoolean( -1);
         Ddo_tiptelnom_Filtertype = "Numeric";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E120O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV12OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV13OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV44TFTipTelId',fld:'vTFTIPTELID',pic:'ZZZZZZZZ9'},{av:'AV45TFTipTelId_To',fld:'vTFTIPTELID_TO',pic:'ZZZZZZZZ9'},{av:'AV48TFTipTelNom',fld:'vTFTIPTELNOM',pic:'ZZZ9'},{av:'AV49TFTipTelNom_To',fld:'vTFTIPTELNOM_TO',pic:'ZZZ9'},{av:'AV37ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV30ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV50ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'AV63Pgmname',fld:'vPGMNAME',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E130O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV12OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV13OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV44TFTipTelId',fld:'vTFTIPTELID',pic:'ZZZZZZZZ9'},{av:'AV45TFTipTelId_To',fld:'vTFTIPTELID_TO',pic:'ZZZZZZZZ9'},{av:'AV48TFTipTelNom',fld:'vTFTIPTELNOM',pic:'ZZZ9'},{av:'AV49TFTipTelNom_To',fld:'vTFTIPTELNOM_TO',pic:'ZZZ9'},{av:'AV37ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV30ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV50ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'AV63Pgmname',fld:'vPGMNAME',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_TIPTELID.ONOPTIONCLICKED","{handler:'E140O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV12OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV13OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV44TFTipTelId',fld:'vTFTIPTELID',pic:'ZZZZZZZZ9'},{av:'AV45TFTipTelId_To',fld:'vTFTIPTELID_TO',pic:'ZZZZZZZZ9'},{av:'AV48TFTipTelNom',fld:'vTFTIPTELNOM',pic:'ZZZ9'},{av:'AV49TFTipTelNom_To',fld:'vTFTIPTELNOM_TO',pic:'ZZZ9'},{av:'AV37ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV30ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV50ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'AV63Pgmname',fld:'vPGMNAME',pic:''},{av:'Ddo_tiptelid_Activeeventkey',ctrl:'DDO_TIPTELID',prop:'ActiveEventKey'},{av:'Ddo_tiptelid_Filteredtext_get',ctrl:'DDO_TIPTELID',prop:'FilteredText_get'},{av:'Ddo_tiptelid_Filteredtextto_get',ctrl:'DDO_TIPTELID',prop:'FilteredTextTo_get'}]");
         ...
         setEventMetadata("DDO_TIPTELNOM.ONOPTIONCLICKED","{handler:'E150O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV12OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV13OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV44TFTipTelId',fld:'vTFTIPTELID',pic:'ZZZZZZZZ9'},{av:'AV45TFTipTelId_To',fld:'vTFTIPTELID_TO',pic:'ZZZZZZZZ9'},{av:'AV48TFTipTelNom',fld:'vTFTIPTELNOM',pic:'ZZZ9'},{av:'AV49TFTipTelNom_To',fld:'vTFTIPTELNOM_TO',pic:'ZZZ9'},{av:'AV37ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV30ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV50ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'AV63Pgmname',fld:'vPGMNAME',pic:''},{av:'Ddo_tiptelnom_Activeeventkey',ctrl:'DDO_TIPTELNOM',prop:'ActiveEventKey'},{av:'Ddo_tiptelnom_Filteredtext_get',ctrl:'DDO_TIPTELNOM',prop:'FilteredText_get'},{av:'Ddo_tiptelnom_Filteredtextto_get',ctrl:'DDO_TIPTELNOM',prop:'FilteredTextTo_get'}]");
         setEventMetadata("DDO_TIPTELNOM.ONOPTIONCLICKED",",oparms:[{av:'AV12OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV13OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_tiptelnom_Sortedstatus',ctrl:'DDO_TIPTELNOM',prop:'SortedStatus'},{av:'AV48TFTipTelNom',fld:'vTFTIPTELNOM',pic:'ZZZ9'},{av:'AV49TFTipTelNom_To',fld:'vTFTIPTELNOM_TO',pic:'ZZZ9'},{av:'Ddo_tiptelid_Sortedstatus',ctrl:'DDO_TIPTELID',prop:'SortedStatus'},{av:'AV43TipTelIdTitleFilterData',fld:'vTIPTELIDTITLEFILTERDATA',pic:''},{av:'AV47TipTelNomTitleFilterData',fld:'vTIPTELNOMTITLEFILTERDATA',pic:''},{av:'AV37ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV30ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtTipTelId_Visible',ctrl:'TIPTELID',prop:'Visible'},{av:'edtTipTelNom_Visible',ctrl:'TIPTELNOM',prop:'Visible'},{av:'edtTipTelId_Titleformat',ctrl:'TIPTELID',prop:'Titleformat'},{av:'edtTipTelId_Title',ctrl:'TIPTELID',prop:'Title'},{av:'edtTipTelNom_Titleformat',ctrl:'TIPTELNOM',prop:'Titleformat'},{av:'edtTipTelNom_Title',ctrl:'TIPTELNOM',prop:'Title'},{av:'AV53GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV54GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV41ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV10GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E220O2',iparms:[{av:'A1TipTelId',fld:'TIPTELID',pic:'ZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E160O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV12OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV13OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV44TFTipTelId',fld:'vTFTIPTELID',pic:'ZZZZZZZZ9'},{av:'AV45TFTipTelId_To',fld:'vTFTIPTELID_TO',pic:'ZZZZZZZZ9'},{av:'AV48TFTipTelNom',fld:'vTFTIPTELNOM',pic:'ZZZ9'},{av:'AV49TFTipTelNom_To',fld:'vTFTIPTELNOM_TO',pic:'ZZZ9'},{av:'AV37ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV30ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV46ddo_TipTelIdTitleControlIdToReplace',fld:'vDDO_TIPTELIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV50ddo_TipTelNomTitleControlIdToReplace',fld:'vDDO_TIPTELNOMTITLECONTROLIDTOREPLACE',pic:''},{av:'AV63Pgmname',fld:'vPGMNAME',pic:''},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
      ...
      public override void initialize( )
      {
         ...
         Ddo_tiptelnom_Filteredtextto_get = "";
         ...
         sEvtType = "";
         scmdbuf = "";
         lV58TipoTelefonoWWDS_1_Filterfulltext = "";
         AV58TipoTelefonoWWDS_1_Filterfulltext = "";
         H000O2_A3TipTelNom = new short[1] ;
         H000O2_A1TipTelId = new int[1] ;
         ...
         GXCCtl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipotelefonoww__default(),
            new Object[][] {
                new Object[] {
               H000O2_A3TipTelNom, H000O2_A1TipTelId
               }
               , new Object[] {
      ...
      private short AV48TFTipTelNom ;
      private short AV49TFTipTelNom_To ;
      ...
      private short AV61TipoTelefonoWWDS_4_Tftiptelnom ;
      private short AV62TipoTelefonoWWDS_5_Tftiptelnom_to ;
      ...
      private int edtavTftiptelnom_to_Visible ;
      private int subGrid_Islastpage ;
      private int GXPagingFrom2 ;
      private int GXPagingTo2 ;
      private int AV59TipoTelefonoWWDS_2_Tftiptelid ;
      private int AV60TipoTelefonoWWDS_3_Tftiptelid_to ;
      ...
      private String Ddo_tiptelnom_Filteredtextto_get ;
      ...
      private String Ddo_tiptelnom_Filteredtextto_set ;
      ...
      private String Ddo_tiptelnom_Rangefilterfrom ;
      private String Ddo_tiptelnom_Rangefilterto ;
      ...
      private String edtavTftiptelnom_to_Internalname ;
      private String edtavTftiptelnom_to_Jsonclick ;
      private String sEvt ;
      ...
      private String lV58TipoTelefonoWWDS_1_Filterfulltext ;
      private String AV58TipoTelefonoWWDS_1_Filterfulltext ;
      ...
      private short[] H000O2_A3TipTelNom ;
      private int[] H000O2_A1TipTelId ;
   ...
   public class tipotelefonoww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000O2( IGxContext context ,
                                             String AV58TipoTelefonoWWDS_1_Filterfulltext ,
                                             int AV59TipoTelefonoWWDS_2_Tftiptelid ,
                                             int AV60TipoTelefonoWWDS_3_Tftiptelid_to ,
                                             short AV61TipoTelefonoWWDS_4_Tftiptelnom ,
                                             short AV62TipoTelefonoWWDS_5_Tftiptelnom_to ,
                                             int A1TipTelId ,
                                             short A3TipTelNom ,
                                             short AV12OrderedBy ,
                                             bool AV13OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV58TipoTelefonoWWDS_1_Filterfulltext)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (( CONVERT( char(9), CAST([TipTelId] AS decimal(9,0))) like '%' + @lV58TipoTelefonoWWDS_1_Filterfulltext) or ( CONVERT( char(4), CAST([TipTelNom] AS decimal(4,0))) like '%' + @lV58TipoTelefonoWWDS_1_Filterfulltext))";
            }
            else
            {
               sWhereString = sWhereString + " (( CONVERT( char(9), CAST([TipTelId] AS decimal(9,0))) like '%' + @lV58TipoTelefonoWWDS_1_Filterfulltext) or ( CONVERT( char(4), CAST([TipTelNom] AS decimal(4,0))) like '%' + @lV58TipoTelefonoWWDS_1_Filterfulltext))";
            }
         }
         else
         {
         ...
         if ( ! (0==AV59TipoTelefonoWWDS_2_Tftiptelid) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([TipTelId] >= @AV59TipoTelefonoWWDS_2_Tftiptelid)";
            }
            else
            {
               sWhereString = sWhereString + " ([TipTelId] >= @AV59TipoTelefonoWWDS_2_Tftiptelid)";
            }
         }
         else
         {
         ...
         if ( ! (0==AV60TipoTelefonoWWDS_3_Tftiptelid_to) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([TipTelId] <= @AV60TipoTelefonoWWDS_3_Tftiptelid_to)";
            }
            else
            {
               sWhereString = sWhereString + " ([TipTelId] <= @AV60TipoTelefonoWWDS_3_Tftiptelid_to)";
            }
         }
         else
         {
         ...
         if ( ! (0==AV61TipoTelefonoWWDS_4_Tftiptelnom) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([TipTelNom] >= @AV61TipoTelefonoWWDS_4_Tftiptelnom)";
            }
            else
            {
               sWhereString = sWhereString + " ([TipTelNom] >= @AV61TipoTelefonoWWDS_4_Tftiptelnom)";
            }
         }
         else
         {
         ...
         if ( ! (0==AV62TipoTelefonoWWDS_5_Tftiptelnom_to) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([TipTelNom] <= @AV62TipoTelefonoWWDS_5_Tftiptelnom_to)";
            }
            else
            {
               sWhereString = sWhereString + " ([TipTelNom] <= @AV62TipoTelefonoWWDS_5_Tftiptelnom_to)";
            }
         }
         else
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000O2(context, (String)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (int)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (bool)dynConstraints[8] );
               case 1 :
                     return conditional_H000O3(context, (String)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (int)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (bool)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV58TipoTelefonoWWDS_1_Filterfulltext",SqlDbType.NVarChar,100,0} ,
          new Object[] {"@lV58TipoTelefonoWWDS_1_Filterfulltext",SqlDbType.NVarChar,100,0} ,
          new Object[] {"@AV59TipoTelefonoWWDS_2_Tftiptelid",SqlDbType.Int,9,0} ,
          new Object[] {"@AV60TipoTelefonoWWDS_3_Tftiptelid_to",SqlDbType.Int,9,0} ,
          new Object[] {"@AV61TipoTelefonoWWDS_4_Tftiptelnom",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV62TipoTelefonoWWDS_5_Tftiptelnom_to",SqlDbType.SmallInt,4,0} ,
