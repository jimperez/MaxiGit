...
!0):(a.paused=!1,a.autoPlay()))},0)})};e.fn.slick=function(){var a=arguments[0],b=Array.prototype.slice.call(arguments,1),e=this.length,d=0,k;for(d;d<e;d++)if("object"==typeof a||"undefined"==typeof a?this[d].slick=new c(this[d],a):k=this[d].slick[a].apply(this[d].slick,b),"undefined"!=typeof k)return k;return this}});gx.uc.HorizontalGrid=function(e){var c,a=!1,b=gx.lang.gxBoolean,f=gx.dom;this.getCurrentPage=function(){return this.CurrentPage=c?c.slick("slickCurrentSlide")+1:1};this.setCurrentPage=function(a){this.CurrentPage=a;c&&c.slick("slickGoTo",a-1,!0)};this.show=function(){var d;d=this.gxGridResponsiveCols;var k=d[0],h=d[1],g=d[2],l=d[3],m=this.MultiRowsExtraSmall,n=this.MultiRowsSmall,q=this.MultiRowsMedium,r=this.MultiRowsLarge,p=b(this.Paged)?!1:1;c=e(this.getContainerControl());d=c.attr("id");c.css("opacity",
0);d=this.drawGrid(d+"Tbl",!this.IsPostBack);c.hasClass("slick-slider")&&c.slick("unslick");this.checkUnsupportedTableNesting();b(this.ShowArrows)&&c.css("margin-left",10).css("margin-right",10);c.html(d);this.gxWidth&&c.width(f.addUnits(this.gxWidth,this.gxWidthUnit));this.gxHeight&&c.height(f.addUnits(this.gxHeight,this.gxHeightUnit));this.PageControllerClass&&c.addClass(this.PageControllerClass);a||(a=!0,gx.fx.obs.addObserver("gx.plugdesign.onafterapplytemplate",this,function(){var d=function(){gx.lang.requestAnimationFrame(function(){c.on("init",
function(){setTimeout(function(){c.css("opacity",1)},10);a=!1});c.slick({arrows:b(this.ShowArrows),adaptiveHeight:!1,autoplay:b(this.AutoPlay),autoplaySpeed:this.AutoPlaySpeed,centerMode:!1,dots:b(this.ShowPageController),infinite:b(this.Infinite),variableWidth:b(this.VariableWidth),initialSlide:(this.CurrentPage||1)-1,speed:500,slidesToShow:l,slidesToScroll:p||l,rows:r,responsive:[{breakpoint:768,settings:{rows:m,slidesToShow:k,slidesToScroll:p||k}},{breakpoint:992,settings:{rows:n,slidesToShow:h,
slidesToScroll:p||h}},{breakpoint:1200,settings:{rows:q,slidesToShow:g,slidesToScroll:p||g}}]})}.closure(this))}.closure(this);if(c.is("[data-gx-grid-rendering-additive-rows] #"+c.get(0).id))c.parent().closest("[data-gx-grid-rendering-additive-rows]").one("gx-grid:after-additive-rows-render",d);else d()},{single:!0}))};this.destroy=function(){c.hide();c&&c.slick("unslick")};this.checkUnsupportedTableNesting=function(){for(var a=this.getContainerControl(),b=!1;a;){if(b="TABLE"==a.tagName||"DIV"==a.tagName&&
null!==a.getAttribute("data-align-inner")||"DIV"==a.tagName&&null!==a.getAttribute("data-align-outer")){gx.dbg.write("Important: Web Horizontal Grid does not support being nested neither inside aligned cells nor Table controls.",!0);break}a=a.parentNode}};this.appendRowEnd=this.appendRowStart=this.appendContainerEnd=this.appendContainerStart=gx.emptyFn;this.getRowRenderingProps=function(){return{cls:"",tag:"div"}};this.appendRowPrefix=this.appendFooterWrapperEnd=this.appendFooterWrapperStart=gx.emptyFn};
