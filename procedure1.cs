/*
       ...
       Generated on: 11/1/2019 11:59:10.36
...
namespace GeneXus.Programs {
   public class procedure1 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void executeSubmit( )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objprocedure1);
      }
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV8Texto = "HOLA MUNDO";
            H0A0( false, 100) ;
            getPrinter().GxDrawLine(161, Gx_line+47, 450, Gx_line+47, 1, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Arial Narrow", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV8Texto, "")), 0, Gx_line+0, 168, Gx_line+17, 0+256, 0, 0, 0) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText("Text", 567, Gx_line+50, 590, Gx_line+64, 0+256, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
