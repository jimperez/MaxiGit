...
using System.IO;
public class bldtipotelefonoww : GxBaseBuilder
{
   string cs_path = "." ;
   public bldtipotelefonoww( ) : base()
   {
   }
   ...
   {
      bldtipotelefonoww x = new bldtipotelefonoww() ;
      x.SetMainSourceFile( "tipotelefonoww.cs");
