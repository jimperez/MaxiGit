/*!   GeneXus C# 16_0_5-135614 on 11/1/2019 9:14:49.3
*/
...
gx.define('appmasterpage', false, function () {
   ...
   GXValidFnc[8]={ id: 8, fld:"APPLICATIONHEADER", format:0,grid:0};
   GXValidFnc[10]={ id: 10, fld:"TABLE3",grid:0};
   GXValidFnc[13]={ id: 13, fld:"ENGLISH", format:0,grid:0};
   GXValidFnc[15]={ id: 15, fld:"PIPE", format:0,grid:0};
   GXValidFnc[17]={ id: 17, fld:"SPANISH", format:0,grid:0};
   GXValidFnc[19]={ id: 19, fld:"PIPE2", format:0,grid:0};
   GXValidFnc[21]={ id: 21, fld:"PORTUGUESE", format:0,grid:0};
   GXValidFnc[22]={ id: 22, fld:"TABLE4",grid:0};
   GXValidFnc[25]={ id: 25, fld:"FIRSTTEXT", format:0,grid:0};
   GXValidFnc[27]={ id: 27, fld:"SECONDTEXT", format:0,grid:0};
   GXValidFnc[29]={ id: 29, fld:"THIRDTEXT", format:0,grid:0};
   GXValidFnc[31]={ id: 31, fld:"FOURTHTEXT", format:0,grid:0};
   GXValidFnc[42]={ id: 42, fld:"TABLE6",grid:0};
   GXValidFnc[47]={ id: 47, fld:"TABLE7",grid:0};
   GXValidFnc[50]={ id: 50, fld:"TEXTBLOCK1", format:0,grid:0};
