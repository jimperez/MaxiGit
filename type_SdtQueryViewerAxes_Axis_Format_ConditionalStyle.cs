...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Format.ConditionalStyle" , Namespace="MaxiPrueba" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Format.ConditionalStyle", Namespace="MaxiPrueba")]
